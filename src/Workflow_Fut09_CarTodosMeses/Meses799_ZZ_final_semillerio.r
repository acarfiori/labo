...
PARAM  <- list()
PARAM$experimento  <- "60VarMesesFinal_09_ZZ"
PARAM$exp_input  <- "60VarMeses_09_HT"

#Atencion, que cada modelos se procesa con 5 semillas, ajuste a SUS necesidades
PARAM$modelos_rank  <- c( 1, 5, 11, 15, 19 )  #Que modelos quiero, segun su posicion en el ranking e la Bayesian Optimizacion, ordenado por ganancia descendente
