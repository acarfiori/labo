# Experimentos Colaborativos 60Var f9 90 Semillas
# ZZ con semillerio
...
PARAM  <- list()
PARAM$experimento  <- "60Var90Sem_09_ZZ"
...
PARAM$semillerio  <- 90   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
